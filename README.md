...
I focus on solving real-world problems using data-driven solutions and modern engineering practices.
...
Tech Used: Python, NLP, Scikit-learn, Flask
...
Tech Used: Python, ML Algorithms, Cloud Deployment
...
🔹 NLP-based model
🔹 Improved communication efficiency by 40%

Tech Used: NLP, Machine Learning, Backend APIs
...
🔹 System automation
🔹 API integrations (weather, news, search)

Tech Used: Python, NLP, Speech Processing
...
Real-world on-chain & AI products
...
AI + Cloud + Automation + Real-World Impact
